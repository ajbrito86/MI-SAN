...
export function AppButton({ titulo, variante = 'primario', ...props }: AppButtonProps) {
  ...
  return (
    <Pressable className={`min-h-14 items-center justify-center rounded-lg px-5 ${clases}`} {...props}>
