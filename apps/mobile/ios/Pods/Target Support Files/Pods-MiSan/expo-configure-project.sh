...
with_node \
  ...
  --target "/Users/ajbrito/Documents/repos/MI-SAN/apps/mobile/ios/Pods/Target Support Files/Pods-MiSan/ExpoModulesProvider.swift" \
  --entitlement "/Users/ajbrito/Documents/repos/MI-SAN/apps/mobile/ios/MiSan/MiSan.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-crypto" "expo-device" "expo-document-picker" "expo-file-system" "expo-keep-awake" "expo-linking" "expo-router" "expo-web-browser"
