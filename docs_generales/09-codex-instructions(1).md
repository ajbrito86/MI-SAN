...
Mi-San será una aplicación dirigida inicialmente al público latino.

Por tanto:

- La aplicación NO tendrá soporte multiidioma en el MVP.
- Toda la interfaz de usuario debe estar únicamente en español.
- Todos los mensajes visibles para el usuario deben estar en español.
- Los errores amigables deben estar en español.
- Los nombres de variables deben escribirse en español.
- Los nombres de métodos y funciones deben escribirse en español.
- Los nombres de clases, servicios, controladores, módulos y DTOs deben escribirse en español cuando sea razonable.
- Los comentarios, cuando sean necesarios, deben escribirse en español.
- Los nombres técnicos propios de librerías, frameworks o convenciones obligatorias pueden mantenerse en inglés.
...
> Codex debe desarrollar el código de Mi-San en español, tanto en frontend como en backend, excepto donde una librería o framework exija nombres específicos en inglés.
